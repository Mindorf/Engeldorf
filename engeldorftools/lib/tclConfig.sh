...
# build directory.
TCL_BUILD_LIB_SPEC='-L/mnt/engeldorf/sources/tcl8.5.11/unix -ltcl8.5'
...
# compiled.
TCL_SRC_DIR='/mnt/engeldorf/sources/tcl8.5.11'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/mnt/engeldorf/sources/tcl8.5.11/unix -ltclstub8.5'
...
TCL_BUILD_STUB_LIB_PATH='/mnt/engeldorf/sources/tcl8.5.11/unix/libtclstub8.5.a'
